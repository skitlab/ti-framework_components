...
override PKGDIR = ti/sdo/fc/scpy
...
package/%.xdc.inc package/%_ti.sdo.fc.scpy.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.fc.scpy" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.fc.scpy $@

.libraries,v5T .libraries: lib/debug/scpy.av5T

-include lib/debug/scpy.av5T.mak
lib/debug/scpy.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/scpy/package/package_ti.sdo.fc.scpy.ov5T package/lib/lib/debug/scpy/scpy.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/scpy/package/package_ti.sdo.fc.scpy.ov5T package/lib/lib/debug/scpy/scpy.ov5T 
lib/debug/scpy.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/scpy.av5T
.libraries,v5T .libraries: lib/release/scpy.av5T

-include lib/release/scpy.av5T.mak
lib/release/scpy.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/scpy/package/package_ti.sdo.fc.scpy.ov5T package/lib/lib/release/scpy/scpy.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/scpy/package/package_ti.sdo.fc.scpy.ov5T package/lib/lib/release/scpy/scpy.ov5T 
lib/release/scpy.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/scpy.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.fc.scpy.ov5T,copy
package_ti.sdo.fc.scpy.ov5T,copy : package_ti.sdo.fc.scpy.ov5T,0,copy package_ti.sdo.fc.scpy.ov5T,1,copy 
	@

package_ti.sdo.fc.scpy.ov5T,0,copy : package/lib/lib/debug/scpy/package/package_ti.sdo.fc.scpy.ov5T
package_ti.sdo.fc.scpy.ov5T,1,copy : package/lib/lib/release/scpy/package/package_ti.sdo.fc.scpy.ov5T
.PHONY: package_ti.sdo.fc.scpy.sv5T,copy
package_ti.sdo.fc.scpy.sv5T,copy : package_ti.sdo.fc.scpy.sv5T,0,copy package_ti.sdo.fc.scpy.sv5T,1,copy 
	@

package_ti.sdo.fc.scpy.sv5T,0,copy : package/lib/lib/debug/scpy/package/package_ti.sdo.fc.scpy.sv5T
package_ti.sdo.fc.scpy.sv5T,1,copy : package/lib/lib/release/scpy/package/package_ti.sdo.fc.scpy.sv5T
.PHONY: scpy.ov5T,copy
scpy.ov5T,copy : scpy.ov5T,0,copy scpy.ov5T,1,copy 
	@

scpy.ov5T,0,copy : package/lib/lib/debug/scpy/scpy.ov5T
scpy.ov5T,1,copy : package/lib/lib/release/scpy/scpy.ov5T
.PHONY: scpy.sv5T,copy
scpy.sv5T,copy : scpy.sv5T,0,copy scpy.sv5T,1,copy 
	@

scpy.sv5T,0,copy : package/lib/lib/debug/scpy/scpy.sv5T
scpy.sv5T,1,copy : package/lib/lib/release/scpy/scpy.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_fc_scpy
ti_sdo_fc_scpy.tar: package/package.bld.xml
ti_sdo_fc_scpy.tar: package/package.ext.xml
ti_sdo_fc_scpy.tar: package/package.rel.dot
ti_sdo_fc_scpy.tar: package/build.cfg
ti_sdo_fc_scpy.tar: package/package.xdc.inc
ti_sdo_fc_scpy.tar: scpy.h
ti_sdo_fc_scpy.tar: package.bld
ti_sdo_fc_scpy.tar: simple_GCArmv5T.mak
ti_sdo_fc_scpy.tar: package/package.cfg.xdc.inc
ti_sdo_fc_scpy.tar: lib/debug/scpy.av5T
ti_sdo_fc_scpy.tar: package/package_ti.sdo.fc.scpy.c
ti_sdo_fc_scpy.tar: scpy.c
ti_sdo_fc_scpy.tar: lib/release/scpy.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_fc_scpy.tar.dep
endif
package/rel/ti_sdo_fc_scpy/ti/sdo/fc/scpy/package/package.rel.xml:

ti_sdo_fc_scpy.tar: package/rel/ti_sdo_fc_scpy.xdc.inc package/rel/ti_sdo_fc_scpy/ti/sdo/fc/scpy/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_fc_scpy.xdc.inc,package/rel/ti_sdo_fc_scpy.tar.dep)


release release,ti_sdo_fc_scpy: all ti_sdo_fc_scpy.tar
clean:: .clean
	-$(RM) ti_sdo_fc_scpy.tar
	-$(RM) package/rel/ti_sdo_fc_scpy.xdc.inc
	-$(RM) package/rel/ti_sdo_fc_scpy.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/scpy))
    $(shell $(MKDIR) package/lib/lib/debug/scpy)
endif
ifeq (,$(wildcard package/lib/lib/debug/scpy/package))
    $(shell $(MKDIR) package/lib/lib/debug/scpy/package)
endif
ifeq (,$(wildcard package/lib/lib/release))
    $(shell $(MKDIR) package/lib/lib/release)
endif
ifeq (,$(wildcard package/lib/lib/release/scpy))
    $(shell $(MKDIR) package/lib/lib/release/scpy)
endif
ifeq (,$(wildcard package/lib/lib/release/scpy/package))
    $(shell $(MKDIR) package/lib/lib/release/scpy/package)
endif
endif
clean::
	-$(RMDIR) package
