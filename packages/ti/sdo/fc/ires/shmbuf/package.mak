...
override PKGDIR = ti/sdo/fc/ires/shmbuf
...
package/%.xdc.inc package/%_ti.sdo.fc.ires.shmbuf.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.fc.ires.shmbuf" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.fc.ires.shmbuf $@

.libraries,v5T .libraries: lib/debug/shmbuf.av5T

-include lib/debug/shmbuf.av5T.mak
lib/debug/shmbuf.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T package/lib/lib/debug/shmbuf/shmbuf.ov5T package/lib/lib/debug/shmbuf/shmbuf_params.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T package/lib/lib/debug/shmbuf/shmbuf.ov5T package/lib/lib/debug/shmbuf/shmbuf_params.ov5T 
lib/debug/shmbuf.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/shmbuf.av5T
.libraries,v5T .libraries: lib/release/shmbuf.av5T

-include lib/release/shmbuf.av5T.mak
lib/release/shmbuf.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T package/lib/lib/release/shmbuf/shmbuf.ov5T package/lib/lib/release/shmbuf/shmbuf_params.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T package/lib/lib/release/shmbuf/shmbuf.ov5T package/lib/lib/release/shmbuf/shmbuf_params.ov5T 
lib/release/shmbuf.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/shmbuf.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.fc.ires.shmbuf.ov5T,copy
package_ti.sdo.fc.ires.shmbuf.ov5T,copy : package_ti.sdo.fc.ires.shmbuf.ov5T,0,copy package_ti.sdo.fc.ires.shmbuf.ov5T,1,copy 
	@

package_ti.sdo.fc.ires.shmbuf.ov5T,0,copy : package/lib/lib/debug/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T
package_ti.sdo.fc.ires.shmbuf.ov5T,1,copy : package/lib/lib/release/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.ov5T
.PHONY: package_ti.sdo.fc.ires.shmbuf.sv5T,copy
package_ti.sdo.fc.ires.shmbuf.sv5T,copy : package_ti.sdo.fc.ires.shmbuf.sv5T,0,copy package_ti.sdo.fc.ires.shmbuf.sv5T,1,copy 
	@

package_ti.sdo.fc.ires.shmbuf.sv5T,0,copy : package/lib/lib/debug/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.sv5T
package_ti.sdo.fc.ires.shmbuf.sv5T,1,copy : package/lib/lib/release/shmbuf/package/package_ti.sdo.fc.ires.shmbuf.sv5T
.PHONY: shmbuf.ov5T,copy
shmbuf.ov5T,copy : shmbuf.ov5T,0,copy shmbuf.ov5T,1,copy 
	@

shmbuf.ov5T,0,copy : package/lib/lib/debug/shmbuf/shmbuf.ov5T
shmbuf.ov5T,1,copy : package/lib/lib/release/shmbuf/shmbuf.ov5T
.PHONY: shmbuf.sv5T,copy
shmbuf.sv5T,copy : shmbuf.sv5T,0,copy shmbuf.sv5T,1,copy 
	@

shmbuf.sv5T,0,copy : package/lib/lib/debug/shmbuf/shmbuf.sv5T
shmbuf.sv5T,1,copy : package/lib/lib/release/shmbuf/shmbuf.sv5T
.PHONY: shmbuf_params.ov5T,copy
shmbuf_params.ov5T,copy : shmbuf_params.ov5T,0,copy shmbuf_params.ov5T,1,copy 
	@

shmbuf_params.ov5T,0,copy : package/lib/lib/debug/shmbuf/shmbuf_params.ov5T
shmbuf_params.ov5T,1,copy : package/lib/lib/release/shmbuf/shmbuf_params.ov5T
.PHONY: shmbuf_params.sv5T,copy
shmbuf_params.sv5T,copy : shmbuf_params.sv5T,0,copy shmbuf_params.sv5T,1,copy 
	@

shmbuf_params.sv5T,0,copy : package/lib/lib/debug/shmbuf/shmbuf_params.sv5T
shmbuf_params.sv5T,1,copy : package/lib/lib/release/shmbuf/shmbuf_params.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_fc_ires_shmbuf
ti_sdo_fc_ires_shmbuf.tar: package/package.bld.xml
ti_sdo_fc_ires_shmbuf.tar: package/package.ext.xml
ti_sdo_fc_ires_shmbuf.tar: package/package.rel.dot
ti_sdo_fc_ires_shmbuf.tar: package/build.cfg
ti_sdo_fc_ires_shmbuf.tar: package/package.xdc.inc
ti_sdo_fc_ires_shmbuf.tar: shmbuf.h
ti_sdo_fc_ires_shmbuf.tar: lib
ti_sdo_fc_ires_shmbuf.tar: simple_GCArmv5T.mak
ti_sdo_fc_ires_shmbuf.tar: package.bld
ti_sdo_fc_ires_shmbuf.tar: package/package.cfg.xdc.inc
ti_sdo_fc_ires_shmbuf.tar: lib/debug/shmbuf.av5T
ti_sdo_fc_ires_shmbuf.tar: package/package_ti.sdo.fc.ires.shmbuf.c
ti_sdo_fc_ires_shmbuf.tar: shmbuf.c
ti_sdo_fc_ires_shmbuf.tar: shmbuf_params.c
ti_sdo_fc_ires_shmbuf.tar: lib/release/shmbuf.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_fc_ires_shmbuf.tar.dep
endif
package/rel/ti_sdo_fc_ires_shmbuf/ti/sdo/fc/ires/shmbuf/package/package.rel.xml:

ti_sdo_fc_ires_shmbuf.tar: package/rel/ti_sdo_fc_ires_shmbuf.xdc.inc package/rel/ti_sdo_fc_ires_shmbuf/ti/sdo/fc/ires/shmbuf/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_fc_ires_shmbuf.xdc.inc,package/rel/ti_sdo_fc_ires_shmbuf.tar.dep)


release release,ti_sdo_fc_ires_shmbuf: all ti_sdo_fc_ires_shmbuf.tar
clean:: .clean
	-$(RM) ti_sdo_fc_ires_shmbuf.tar
	-$(RM) package/rel/ti_sdo_fc_ires_shmbuf.xdc.inc
	-$(RM) package/rel/ti_sdo_fc_ires_shmbuf.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/shmbuf))
    $(shell $(MKDIR) package/lib/lib/debug/shmbuf)
endif
ifeq (,$(wildcard package/lib/lib/debug/shmbuf/package))
    $(shell $(MKDIR) package/lib/lib/debug/shmbuf/package)
endif
ifeq (,$(wildcard package/lib/lib/release))
    $(shell $(MKDIR) package/lib/lib/release)
endif
ifeq (,$(wildcard package/lib/lib/release/shmbuf))
    $(shell $(MKDIR) package/lib/lib/release/shmbuf)
endif
ifeq (,$(wildcard package/lib/lib/release/shmbuf/package))
    $(shell $(MKDIR) package/lib/lib/release/shmbuf/package)
endif
endif
clean::
	-$(RMDIR) package
