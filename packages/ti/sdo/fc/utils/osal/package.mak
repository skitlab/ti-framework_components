...
override PKGDIR = ti/sdo/fc/utils/osal
...
package/%.xdc.inc package/%_ti.sdo.fc.utils.osal.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.fc.utils.osal" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.fc.utils.osal $@

.libraries,em3 .libraries: lib/debug/sem.aem3

-include lib/debug/sem.aem3.mak
lib/debug/sem.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oem3 package/lib/lib/debug/sem/OsalFactory.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oem3 package/lib/lib/debug/sem/OsalFactory.oem3 
lib/debug/sem.aem3: export C_DIR=
lib/debug/sem.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/debug/sem.aem3
.libraries,em3 .libraries: lib/release/sem.aem3

-include lib/release/sem.aem3.mak
lib/release/sem.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oem3 package/lib/lib/release/sem/OsalFactory.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oem3 package/lib/lib/release/sem/OsalFactory.oem3 
lib/release/sem.aem3: export C_DIR=
lib/release/sem.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/release/sem.aem3
.libraries,e674 .libraries: lib/debug/sem.ae674

-include lib/debug/sem.ae674.mak
lib/debug/sem.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oe674 package/lib/lib/debug/sem/OsalFactory.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oe674 package/lib/lib/debug/sem/OsalFactory.oe674 
lib/debug/sem.ae674: export C_DIR=
lib/debug/sem.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/debug/sem.ae674
.libraries,e674 .libraries: lib/release/sem.ae674

-include lib/release/sem.ae674.mak
lib/release/sem.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oe674 package/lib/lib/release/sem/OsalFactory.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oe674 package/lib/lib/release/sem/OsalFactory.oe674 
lib/release/sem.ae674: export C_DIR=
lib/release/sem.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/release/sem.ae674
.libraries,v5T .libraries: lib/debug/sem.av5T

-include lib/debug/sem.av5T.mak
lib/debug/sem.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.ov5T package/lib/lib/debug/sem/OsalFactory.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.ov5T package/lib/lib/debug/sem/OsalFactory.ov5T 
lib/debug/sem.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/sem.av5T
.libraries,v5T .libraries: lib/release/sem.av5T

-include lib/release/sem.av5T.mak
lib/release/sem.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.ov5T package/lib/lib/release/sem/OsalFactory.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.ov5T package/lib/lib/release/sem/OsalFactory.ov5T 
lib/release/sem.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/sem.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.fc.utils.osal.oem3,copy
package_ti.sdo.fc.utils.osal.oem3,copy : package_ti.sdo.fc.utils.osal.oem3,0,copy package_ti.sdo.fc.utils.osal.oem3,1,copy 
	@

package_ti.sdo.fc.utils.osal.oem3,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oem3
package_ti.sdo.fc.utils.osal.oem3,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oem3
.PHONY: package_ti.sdo.fc.utils.osal.sem3,copy
package_ti.sdo.fc.utils.osal.sem3,copy : package_ti.sdo.fc.utils.osal.sem3,0,copy package_ti.sdo.fc.utils.osal.sem3,1,copy 
	@

package_ti.sdo.fc.utils.osal.sem3,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.sem3
package_ti.sdo.fc.utils.osal.sem3,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.sem3
.PHONY: OsalFactory.oem3,copy
OsalFactory.oem3,copy : OsalFactory.oem3,0,copy OsalFactory.oem3,1,copy 
	@

OsalFactory.oem3,0,copy : package/lib/lib/debug/sem/OsalFactory.oem3
OsalFactory.oem3,1,copy : package/lib/lib/release/sem/OsalFactory.oem3
.PHONY: OsalFactory.sem3,copy
OsalFactory.sem3,copy : OsalFactory.sem3,0,copy OsalFactory.sem3,1,copy 
	@

OsalFactory.sem3,0,copy : package/lib/lib/debug/sem/OsalFactory.sem3
OsalFactory.sem3,1,copy : package/lib/lib/release/sem/OsalFactory.sem3
.PHONY: package_ti.sdo.fc.utils.osal.oe674,copy
package_ti.sdo.fc.utils.osal.oe674,copy : package_ti.sdo.fc.utils.osal.oe674,0,copy package_ti.sdo.fc.utils.osal.oe674,1,copy 
	@

package_ti.sdo.fc.utils.osal.oe674,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.oe674
package_ti.sdo.fc.utils.osal.oe674,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.oe674
.PHONY: package_ti.sdo.fc.utils.osal.se674,copy
package_ti.sdo.fc.utils.osal.se674,copy : package_ti.sdo.fc.utils.osal.se674,0,copy package_ti.sdo.fc.utils.osal.se674,1,copy 
	@

package_ti.sdo.fc.utils.osal.se674,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.se674
package_ti.sdo.fc.utils.osal.se674,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.se674
.PHONY: OsalFactory.oe674,copy
OsalFactory.oe674,copy : OsalFactory.oe674,0,copy OsalFactory.oe674,1,copy 
	@

OsalFactory.oe674,0,copy : package/lib/lib/debug/sem/OsalFactory.oe674
OsalFactory.oe674,1,copy : package/lib/lib/release/sem/OsalFactory.oe674
.PHONY: OsalFactory.se674,copy
OsalFactory.se674,copy : OsalFactory.se674,0,copy OsalFactory.se674,1,copy 
	@

OsalFactory.se674,0,copy : package/lib/lib/debug/sem/OsalFactory.se674
OsalFactory.se674,1,copy : package/lib/lib/release/sem/OsalFactory.se674
.PHONY: package_ti.sdo.fc.utils.osal.ov5T,copy
package_ti.sdo.fc.utils.osal.ov5T,copy : package_ti.sdo.fc.utils.osal.ov5T,0,copy package_ti.sdo.fc.utils.osal.ov5T,1,copy 
	@

package_ti.sdo.fc.utils.osal.ov5T,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.ov5T
package_ti.sdo.fc.utils.osal.ov5T,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.ov5T
.PHONY: package_ti.sdo.fc.utils.osal.sv5T,copy
package_ti.sdo.fc.utils.osal.sv5T,copy : package_ti.sdo.fc.utils.osal.sv5T,0,copy package_ti.sdo.fc.utils.osal.sv5T,1,copy 
	@

package_ti.sdo.fc.utils.osal.sv5T,0,copy : package/lib/lib/debug/sem/package/package_ti.sdo.fc.utils.osal.sv5T
package_ti.sdo.fc.utils.osal.sv5T,1,copy : package/lib/lib/release/sem/package/package_ti.sdo.fc.utils.osal.sv5T
.PHONY: OsalFactory.ov5T,copy
OsalFactory.ov5T,copy : OsalFactory.ov5T,0,copy OsalFactory.ov5T,1,copy 
	@

OsalFactory.ov5T,0,copy : package/lib/lib/debug/sem/OsalFactory.ov5T
OsalFactory.ov5T,1,copy : package/lib/lib/release/sem/OsalFactory.ov5T
.PHONY: OsalFactory.sv5T,copy
OsalFactory.sv5T,copy : OsalFactory.sv5T,0,copy OsalFactory.sv5T,1,copy 
	@

OsalFactory.sv5T,0,copy : package/lib/lib/debug/sem/OsalFactory.sv5T
OsalFactory.sv5T,1,copy : package/lib/lib/release/sem/OsalFactory.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_fc_utils_osal
ti_sdo_fc_utils_osal.tar: package/package.bld.xml
ti_sdo_fc_utils_osal.tar: package/package.ext.xml
ti_sdo_fc_utils_osal.tar: package/package.rel.dot
ti_sdo_fc_utils_osal.tar: package/build.cfg
ti_sdo_fc_utils_osal.tar: package/package.xdc.inc
ti_sdo_fc_utils_osal.tar: package.bld
ti_sdo_fc_utils_osal.tar: simple_GCArmv5T.mak
ti_sdo_fc_utils_osal.tar: package/package.cfg.xdc.inc
ti_sdo_fc_utils_osal.tar: lib/debug/sem.aem3
ti_sdo_fc_utils_osal.tar: package/package_ti.sdo.fc.utils.osal.c
ti_sdo_fc_utils_osal.tar: OsalFactory.c
ti_sdo_fc_utils_osal.tar: lib/release/sem.aem3
ti_sdo_fc_utils_osal.tar: lib/debug/sem.ae674
ti_sdo_fc_utils_osal.tar: lib/release/sem.ae674
ti_sdo_fc_utils_osal.tar: lib/debug/sem.av5T
ti_sdo_fc_utils_osal.tar: lib/release/sem.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_fc_utils_osal.tar.dep
endif
package/rel/ti_sdo_fc_utils_osal/ti/sdo/fc/utils/osal/package/package.rel.xml:

ti_sdo_fc_utils_osal.tar: package/rel/ti_sdo_fc_utils_osal.xdc.inc package/rel/ti_sdo_fc_utils_osal/ti/sdo/fc/utils/osal/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_fc_utils_osal.xdc.inc,package/rel/ti_sdo_fc_utils_osal.tar.dep)


release release,ti_sdo_fc_utils_osal: all ti_sdo_fc_utils_osal.tar
clean:: .clean
	-$(RM) ti_sdo_fc_utils_osal.tar
	-$(RM) package/rel/ti_sdo_fc_utils_osal.xdc.inc
	-$(RM) package/rel/ti_sdo_fc_utils_osal.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/sem))
    $(shell $(MKDIR) package/lib/lib/debug/sem)
endif
ifeq (,$(wildcard package/lib/lib/debug/sem/package))
    $(shell $(MKDIR) package/lib/lib/debug/sem/package)
endif
ifeq (,$(wildcard package/lib/lib/release))
    $(shell $(MKDIR) package/lib/lib/release)
endif
ifeq (,$(wildcard package/lib/lib/release/sem))
    $(shell $(MKDIR) package/lib/lib/release/sem)
endif
ifeq (,$(wildcard package/lib/lib/release/sem/package))
    $(shell $(MKDIR) package/lib/lib/release/sem/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sdo.fc.utils.osal.pjt
